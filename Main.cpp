...
If K is even, then the center grid will be the left-top one. After the first move, we look at the square's position and the last player played in the grid that includes it.
